export const Roommate = [
  ...
  },
  {
    ...
    department: "Mass Communication",
    about:
      "Halima is a charismatic and outgoing mass communication student with a large following on social media. She enjoys using her platform to promote positive messages and connect with others.",
    religion: "Islam",
    "side-hustle": "Social Media Influencer",
    routine:
      "Halima is a charismatic and outgoing mass communication student with a large following on social media. She enjoys using her platform to promote positive messages and connect with others.",
    hobbies: ["Music", "Social Media", "Volunteering"],
  },
  {
    id: 8,
    imgURL: "",
